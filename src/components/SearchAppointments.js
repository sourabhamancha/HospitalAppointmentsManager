          ...
          <div className="input-group-append">
            ...
            <div className="sort-menu dropdown-menu dropdown-menu-right">
                <button className={
                  ...
                  (this.props.orderBy === 'patName' ? 'active': '')
              }
                  onClick = {e=>this.props.changeOrder('patName', this.props.orderDir)}
                  href="#">
                Patient Name
              </button>
              <button className={
              ...
              <button className={
                  'sort-by dropdown-item ' +
                  (this.props.orderBy === 'patAdd' ? 'active': '')
              } onClick={e => this.props.changeOrder('patAdd', this.props.orderDir)}
                  href="#">
                Address
              </button>
